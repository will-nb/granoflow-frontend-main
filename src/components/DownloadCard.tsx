...
export function DownloadCard({ platform, icon, downloadUrl, description }: DownloadCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* 主卡片 */}
      <div className="relative rounded-2xl p-8 backdrop-blur-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300 overflow-hidden">
        {/* 顶部装饰线 */}
        ...
        <div className="flex flex-col items-center text-center">
          {/* 图标容器 */}
          <motion.div 
            className="mb-6 text-violet-400 relative"
            animate={{ 
          ...
          {/* 平台名称 */}
          <h3 className="mb-3 text-white group-hover:text-violet-300 transition-colors duration-300">
            {platform}
          </h3>
